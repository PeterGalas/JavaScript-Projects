//creates a object to keep tracks of values
const Calculator = {
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if wait second operand is true then updates the operator and exits from the function
...
//esures that AC clears the numbers from the calculator
